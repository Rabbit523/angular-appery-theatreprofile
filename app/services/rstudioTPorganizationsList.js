/**
 * Module initializes rest service rstudioTPorganizationsList
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPorganizationsList',
        deps: ['Apperyio', 'REST', rstudioTPorganizationsListImpl]
    }];
    /**
     * @function rstudioTPorganizationsListImpl
     */
    function rstudioTPorganizationsListImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPorganizationsList.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPorganizationsList.request.query"),
            data: Apperyio.EntityAPI("rstudioTPorganizationsList.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPorganizationsList"
            }
        };
