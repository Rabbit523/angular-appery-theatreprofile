/**
 * Module initializes rest service rstudioTPshowAttendanceDetails
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPshowAttendanceDetails',
        deps: ['Apperyio', 'REST', rstudioTPshowAttendanceDetailsImpl]
    }];
    /**
     * @function rstudioTPshowAttendanceDetailsImpl
     */
    function rstudioTPshowAttendanceDetailsImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPshowAttendanceDetails.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPshowAttendanceDetails.request.query"),
            data: Apperyio.EntityAPI("rstudioTPshowAttendanceDetails.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPshowAttendanceDetails"
            }
        };
