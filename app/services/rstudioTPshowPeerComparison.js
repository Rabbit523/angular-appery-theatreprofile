/**
 * Module initializes rest service rstudioTPshowPeerComparison
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPshowPeerComparison',
        deps: ['Apperyio', 'REST', rstudioTPshowPeerComparisonImpl]
    }];
    /**
     * @function rstudioTPshowPeerComparisonImpl
     */
    function rstudioTPshowPeerComparisonImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPshowPeerComparison.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPshowPeerComparison.request.query"),
            data: Apperyio.EntityAPI("rstudioTPshowPeerComparison.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPshowPeerComparison"
            }
        };
