/**
 * Module initializes rest service rstudioTPshowEventDetails
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPshowEventDetails',
        deps: ['Apperyio', 'REST', rstudioTPshowEventDetailsImpl]
    }];
    /**
     * @function rstudioTPshowEventDetailsImpl
     */
    function rstudioTPshowEventDetailsImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPshowEventDetails.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPshowEventDetails.request.query"),
            data: Apperyio.EntityAPI("rstudioTPshowEventDetails.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPshowEventDetails"
            }
        };
