/**
 * Module initializes rest service Secret_Keys_read_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Secret_Keys_read_service',
        deps: ['Apperyio', 'REST', Secret_Keys_read_serviceImpl]
    }];
    /**
     * @function Secret_Keys_read_serviceImpl
     */
    function Secret_Keys_read_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("Secret_Keys_read_service.request.headers"),
            params: Apperyio.EntityAPI("Secret_Keys_read_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "Secret_Keys_read_service"
            }
        };
