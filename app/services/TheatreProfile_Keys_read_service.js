/**
 * Module initializes rest service TheatreProfile_Keys_read_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'TheatreProfile_Keys_read_service',
        deps: ['Apperyio', 'REST', TheatreProfile_Keys_read_serviceImpl]
    }];
    /**
     * @function TheatreProfile_Keys_read_serviceImpl
     */
    function TheatreProfile_Keys_read_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/Keys/{_id}",
            method: "get",
            headers: Apperyio.EntityAPI("TheatreProfile_Keys_read_service.request.headers"),
            params: Apperyio.EntityAPI("TheatreProfile_Keys_read_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "TheatreProfile_Keys_read_service"
            }
        };
