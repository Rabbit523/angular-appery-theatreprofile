/**
 * Module initializes rest service rstudioTPshowEventGeography
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPshowEventGeography',
        deps: ['Apperyio', 'REST', rstudioTPshowEventGeographyImpl]
    }];
    /**
     * @function rstudioTPshowEventGeographyImpl
     */
    function rstudioTPshowEventGeographyImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPshowEventGeography.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPshowEventGeography.request.query"),
            data: Apperyio.EntityAPI("rstudioTPshowEventGeography.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPshowEventGeography"
            }
        };
