/**
 * Module initializes rest service rstudioTPattendanceByShow
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPattendanceByShow',
        deps: ['Apperyio', 'REST', rstudioTPattendanceByShowImpl]
    }];
    /**
     * @function rstudioTPattendanceByShowImpl
     */
    function rstudioTPattendanceByShowImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPattendanceByShow.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPattendanceByShow.request.query"),
            data: Apperyio.EntityAPI("rstudioTPattendanceByShow.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPattendanceByShow"
            }
        };
