/**
 * Module initializes rest service rstudioTPcompanyShowsPerformance
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPcompanyShowsPerformance',
        deps: ['Apperyio', 'REST', rstudioTPcompanyShowsPerformanceImpl]
    }];
    /**
     * @function rstudioTPcompanyShowsPerformanceImpl
     */
    function rstudioTPcompanyShowsPerformanceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPcompanyShowsPerformance.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPcompanyShowsPerformance.request.query"),
            data: Apperyio.EntityAPI("rstudioTPcompanyShowsPerformance.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPcompanyShowsPerformance"
            }
        };
