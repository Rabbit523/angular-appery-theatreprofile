/**
 * Module initializes rest service rstudioTPallCompanies
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPallCompanies',
        deps: ['Apperyio', 'REST', rstudioTPallCompaniesImpl]
    }];
    /**
     * @function rstudioTPallCompaniesImpl
     */
    function rstudioTPallCompaniesImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPallCompanies.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPallCompanies.request.query"),
            data: Apperyio.EntityAPI("rstudioTPallCompanies.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPallCompanies"
            }
        };
