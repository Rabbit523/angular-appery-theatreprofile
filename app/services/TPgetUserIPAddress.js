/**
 * Module initializes rest service TPgetUserIPAddress
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'TPgetUserIPAddress',
        deps: ['Apperyio', 'REST', TPgetUserIPAddressImpl]
    }];
    /**
     * @function TPgetUserIPAddressImpl
     */
    function TPgetUserIPAddressImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("TPgetUserIPAddress.request.headers"),
            params: Apperyio.EntityAPI("TPgetUserIPAddress.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "TPgetUserIPAddress"
            }
        };
