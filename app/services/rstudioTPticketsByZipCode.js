/**
 * Module initializes rest service rstudioTPticketsByZipCode
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPticketsByZipCode',
        deps: ['Apperyio', 'REST', rstudioTPticketsByZipCodeImpl]
    }];
    /**
     * @function rstudioTPticketsByZipCodeImpl
     */
    function rstudioTPticketsByZipCodeImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("rstudioTPticketsByZipCode.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPticketsByZipCode.request.query"),
            data: Apperyio.EntityAPI("rstudioTPticketsByZipCode.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "rstudioTPticketsByZipCode"
            }
        };
